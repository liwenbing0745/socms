...
Page({
    ...
    onLoad: function (options) {
        ...
        var rd_session = wx.getStorageSync('rd_session');
           server.getJSON('https://xcx.so50.com/Pages/Ajax/GetProDecData.ashx', { id: options.id, userid: rd_session}, function (res) {
        self.setData({
  ...
  withShareTicket: true
    ...
    addCart: function (id, flag) {
         var self = this;
      var rd_session = wx.getStorageSync('rd_session');
        server.getJSON('https://xcx.so50.com/Pages/Ajaxwx/UserAddShop.ashx', { pid: id, isord: flag, buy_sum:self.data.products[0].buy_sum, userid: rd_session }, function (res) {
