...
Page({
  ...
  onLoad: function (options) {
   ...
   tapPddbountyBuy: function (e) {
     var self = this;
        server.getJSON('https://xcx.so50.com/Pages/ajaxsqtg/orderNumList.ashx', { userid: wx.getStorageSync('rd_session'), ssshuqup: e.currentTarget.dataset.id}, function (res) {
