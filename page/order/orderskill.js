...
Page({
    ...
    onLoad: function (options) {
        ...
        server.getJSON('https://xcx.so50.com/Pages/Ajax/GetOrderskillData.ashx', { userid: rd_session }, function (res) {
            self.setData({
    ...
    addCart: function (id) {
        var self = this;
        server.getJSON('https://xcx.so50.com/Pages/Ajax/UpdateSumorderskill.ashx', { id: id, buy_sum: 1 }, function (res) {
            self.setData({
                confirmSubmit: res.data.confirmSubmit,
                goodsList: res.data.goodsList,
                goods: res.data.goods,
    ...
    submit: function (e) {
        ...
        var rd_session = wx.getStorageSync('rd_session');
        var value = e.detail.value;
        server.getJSON('https://xcx.so50.com/Pages/Ajaxwx/UserAddOrderskill.ashx', { userid: rd_session, openid: openid, deliveraddids: value.id, remark: value.remark, invoiceH: value.invoiceH }, function (res) {
