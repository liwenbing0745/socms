...
Page({
    ...
    onShow: function (options) {
        ...
        server.getJSON('https://xcx.so50.com/Pages/Ajax/GetOrdersqtgData.ashx', { userid: rd_session }, function (res) {
            self.setData({
    ...
    submit: function (e) {
        ...
        server.getJSON('https://xcx.so50.com/Pages/Ajaxwx/UserAddOrdersqtg.ashx', { userid: rd_session, openid: openid, consigneepeo: value.consigneepeo, consigneemobile: value.consigneemobile, remark: value.remark, invoiceH: value.invoiceH }, function (res) {
